...
const iconClass = "w-6 h-6 text-[var(--sec)] opacity-70";
...
const CategoryIcons: Record<Category, React.ReactNode> = {
  ...
  "Cloud, DevOps & Testing": (
    <svg
      ...
      className={iconClass}
    >
      <circle cx="8.5" cy="12" r="4"></circle>
      <circle cx="13.5" cy="10.5" r="5"></circle>
      <circle cx="17.5" cy="14" r="3.5"></circle>
      <rect x="5" y="13.5" width="14" height="5" rx="2.5"></rect>
    </svg>
  ),
  "AI & Machine Learning": (
    <svg
...
const skills: Record<Category, string[]> = {
  "Backend & APIs": [
    "REST APIs with ASP.NET Core, Spring Boot and NestJS",
    "EF Core, Prisma and JPA over PostgreSQL and SQL Server",
    "Auth flows, concurrency control and RFC 9457 error handling",
  ],
  Frontend: [
    "React and Angular SPAs against real APIs",
    "Next.js App Router — Server Components and Server Actions",
    "TypeScript, TanStack Query and accessible markup",
  ],
  "Cloud, DevOps & Testing": [
    "Azure with Bicep, Key Vault and credential-free OIDC pipelines",
    "Docker, Docker Compose and GitHub Actions publishing to GHCR",
    "xUnit, JUnit 5, Vitest, Playwright and Testcontainers",
  ],
  "AI & Machine Learning": [
